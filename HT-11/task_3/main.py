# 3. Банкомат 3.0: переробіть программу з функціонального підходу програмування на використання
# класів. Додайте шанс 10% отримати бонус на баланс (50 одиниць) при створенні нового користувача.
        ...
        while True:
            ...
            match action:
                ...
                case "withdraw":
                    ...
                    res = Validation(self.db).has_needed_banknotes(needed_money=money)
                    if res is not True:
                        print(
